...
<head>
    <meta charset="UTF-8">
    <title>Usuários Reprovados - Airbnb Pet</title>
...
$sql = "SELECT * FROM cadastro 
        WHERE status_online = 'reprovado' AND 
...
$resultado = $conexao->query($sql);
        ...
        if (isset($_POST['reanalise'])) {
            ...
            if ($_POST['reanalise'] == 'excluir'){
               
    
                $sql3 = "DELETE FROM cadastro WHERE cpf = '" . $_POST['cpf_temp'] . "'";
                ...
                if ($resultado3) {
                  ...
                  header("refresh:2; url=exibirimoveis_root_reprovados.php");
                    exit;
                } else {
                echo "Erro ao excluir no banco de dados: " . mysqli_error($conexao);
                }           
            }
            }
...
if ($resultado->num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        echo '  <form action="exibirimoveis_root_reprovados.php" method="post" enctype="multipart/form-data">
