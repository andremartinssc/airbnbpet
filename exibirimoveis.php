...
<head>
    <meta charset="UTF-8">
    <title>Imoveis Disponiveis Palhoça - Airbnb Pet</title>
...
<body>
    ...
    <div id="profile">
        ...
        <div class="search-form-container">
            <form method="GET" action="exibirimoveis.php">
    ...
    <h1>Locais Disponíveis Palhoça</h1>
...
$sql = "SELECT * FROM cadastro 
        WHERE status_online = 'publicado' AND cidade = 'palhoca' AND 
